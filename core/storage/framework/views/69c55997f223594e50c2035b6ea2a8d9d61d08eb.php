...
<aside id="sidebar" class="sidebar">
   <ul class="sidebar-nav" id="sidebar-nav">
      <li class="nav-item">
         <a class="nav-link <?php echo e(request()->is('user/dashboard') ? 'active' : ''); ?>" href="<?php echo e(route('user.home')); ?>">
      ...
      <li class="nav-item">
         <a class="nav-link <?php echo e(request()->is('user/profile-setting') ? 'active' : ''); ?>" href="<?php echo e(route('user.profile-setting')); ?>">
         <i class="bi bi-dash-circle"></i>
         <span>Settings</span>
         </a>
      </li>
